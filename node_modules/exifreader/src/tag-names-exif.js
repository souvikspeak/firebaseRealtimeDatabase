...
export default {
    ...
    //         const options = [];
    //         if (value & 0b0001) {
    //             options.push('2-Dimensional');
    //         } else {
    //             options.push('1-Dimensional');
    //         }
    //         if (value & 0b0010) {
    //             options.push('Uncompressed');
    //         } else {
    //             options.push('Compressed');
    //         }
    //         if (value & 0b0100) {
    //             options.push('Byte-aligned EOLs');
    //         } else {
    //             options.push('Non-byte-aligned EOLs');
    //         }
    //         return options.join(', ');
    //     }
    // },
    ...
    0xa462: 'SourceExposureTimesOfCompositeImage the EXIF spec.)',
    0xa500: 'Gamma',
    0xea1c: 'Padding',
    0xea1d: 'OffsetSchema',
    0xfde8: 'OwnerName',
